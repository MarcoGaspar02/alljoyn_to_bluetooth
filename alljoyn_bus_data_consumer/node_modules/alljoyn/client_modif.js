...
var listener = alljoyn.BusListener(
  function(name){
    ...
    // Modificando para usar o endereço IP na rede local
    sessionId = bus.joinSession("10.0.2.0", portNumber, 0); // Modifique o endereço conforme necessário
...
// Não é necessário mais, pois você não está mais procurando o nome anunciado
